...
> = {
  ...
  DISPATCHING: ["DISPATCHED", "QUEUED", "FAILED"],
  DISPATCHED: ["PROCESSING", "WAITING_APPROVAL", "FAILED", "QUEUED"],
  PROCESSING: [
    "COMPLETED",
    "FAILED",
    "RATE_LIMITED",
  ...
  WAITING_APPROVAL: ["PROCESSING", "FAILED", "QUEUED"],
  RATE_LIMITED: ["QUEUED", "FAILED"],
